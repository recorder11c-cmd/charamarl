...
(function(){
  ...
  function watermark(ctx, W, H){
    ...
    var tw2 = ctx.measureText('charamarl.com').width;
    ...
    ctx.font = '700 ' + Math.round(20 * u) + 'px "Helvetica Neue", Arial, sans-serif';
    ctx.fillStyle = '#111'; ctx.fillText('charamarl.com', x + pad, y + 64 * u);
    ctx.restore();
  }
  ...
  function share(o){
    return toBlob(o.canvas).then(function(blob){
      ...
      if(navigator.canShare && navigator.canShare({ files: [file] })){
        return navigator.share({ files: [file], text: text }).then(function(){ return 'native'; }).catch(function(e){ if(e && e.name === 'AbortError') return 'cancel'; return fallback(blob, o); });
      }
  ...
  window.CM_AR_SHARE = { snapshot: snapshot, share: share };
})();
