...
const ALLOWED_CHARS = ['SUE', 'PUTTI', 'MOSSUN', 'GMC', 'UFOO', 'KAGECHIYO', 'YURUCRAZY', 'DOGOOOOO', 'INKUMO', 'DANNA', 'BLOCKMA', 'MONY', 'SANTAMA_KAGECHIYO', 'SANTAMA_KIMI', 'SANTAMA_SHIGURE', 'SANTAMA_PROM', 'SANTAMA_MUCHIKO', 'JUNK_AGERU', 'JUNK_PIZZAHAT', 'JUNK_BLT', 'JUNK_POPCORN', 'JUNK_BUKGAHOP'];   // 公開キャラのみ受け付ける(プロンプト公開後のコピー流入対策)
